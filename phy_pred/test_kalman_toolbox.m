...
[xsmooth, Vsmooth] = kalman_smoother(y, F, H, Q, R, initx, initV, 'model', model);
...
for t=1:T, plotgauss2d(xfilt(1:2,t), Vfilt(1:2, 1:2, t) / 14); end
hold off
...
for t=1:T, plotgauss2d(xsmooth(1:2,t), Vsmooth(1:2, 1:2, t) / 14); end
hold off
