...
%     m.vdetectors(i987576).lamda = m.vdetectors(i987576).lamda + gd_learning_rate * m.vdetectors(i987576).derivative;
    m.vdetectors(i987576).lamda = m.vdetectors(i987576).lamda * exp( gd_learning_rate * m.vdetectors(i987576).derivative );
%     m.vdetectors(i987576).lamda = max(0.01, m.vdetectors(i987576).lamda);
